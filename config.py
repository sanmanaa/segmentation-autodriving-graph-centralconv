...
__C.ASSETS_PATH = '/home/zcy/lyj/hms_conv2d/assets/'
...
__C.DATASET.CITYSCAPES_DIR = \
  os.path.join(__C.ASSETS_PATH, '/home/zcy/lyj/HANet-master/cityscapes/')
__C.DATASET.CITYSCAPES_CUSTOMCOARSE = \
  os.path.join(__C.ASSETS_PATH, '/home/zcy/lyj/semantic-segmentation-main/data/Cityscapes/autolabelled/')
...
__C.DATASET.MAPILLARY_DIR = os.path.join(__C.ASSETS_PATH, '/home/zcy/lyj/hms_conv2d/assets/mapillary/')
